...
/**
 * Read-side code block with shiki syntax highlighting + copy-to-clipboard.
 * Opt-in: inject via `renderLexical(doc, { components: { code: CodeBlockRender } })`.
 * `shiki` is loaded lazily, so consumers that never render a code block don't
 * pull the highlighter into their bundle.
 */
    ...
    >
      ...
      {html ? (
        <div
          ...
          // biome-ignore lint/security/noDangerouslySetInnerHtml: shiki output is trusted, generated from the message's own code text
