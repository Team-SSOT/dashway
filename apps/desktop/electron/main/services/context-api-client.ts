...
function getContextApiUrl(): string {
  return process.env.DASHWAY_CONTEXT_API_URL ?? DEFAULT_CONTEXT_API_URL
}
...
export { AUTHENTICATION_REQUIRED_MESSAGE, getGraphqlErrorMessage, isAuthenticationRequiredError }
